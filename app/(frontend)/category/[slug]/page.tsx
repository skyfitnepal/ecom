...
import { Image as ImageIcon, Star, ChevronRight, Grid, Filter } from 'lucide-react'
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-10 sm:py-12">
          ...
          <div className="flex items-center gap-2 text-xs font-semibold text-gray-400 mb-4">
            ...
            <ChevronRight size={12} className="text-gray-300" />
            <span className="text-[#128a88] font-bold">{categoryName}</span>
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1 max-w-xl">
                  Premium gear and apparel for high-performance {categoryName.toLowerCase()} workouts.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          ...
          <div className="flex items-center justify-between border-b border-gray-100 pb-5 mb-8 text-sm">
            <div className="flex items-center gap-2 text-gray-500 font-medium">
              ...
              <span>Showing <strong className="text-gray-900 font-bold">{products.length}</strong> results</span>
            </div>
            <div className="flex items-center gap-2 border border-gray-200 px-3 py-1.5 rounded-lg text-xs font-semibold text-gray-600 bg-gray-50">
          ...
          {products.length === 0 ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 sm:gap-x-6 gap-y-10">
              {products.map((product) => (
                ...
                >
                  {/* Image Container with thin border and clean gray bg */}
